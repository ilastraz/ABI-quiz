// Funzione che verifica se il bottone esiste e assegna il listener di click
function initializeQuizButton() {
  ...
  if (startButton) {
    ...
    // Una volta aggiunto l'event listener, ferma l'intervallo
    clearInterval(startButtonInterval);
  }
}

// Verifica ripetutamente se l'elemento è stato caricato nel DOM (ogni 100ms)
const startButtonInterval = setInterval(initializeQuizButton, 100);

// Altre funzioni JavaScript come startQuiz(), mostraDomanda(), etc.
let domande = [];
